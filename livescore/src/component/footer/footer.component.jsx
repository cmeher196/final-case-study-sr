...
const Footer = props => {
    return (
        <footer class="footer-distributed">
            ...
            <img src={logo} alt="cricket" width="200px" height="100px" />
                <p class="footer-company-name">Live Score App © 2021</p>
                ...
                <div class="footer-icons">
                    ...
                    <a href="https://www.linkedin.com/in/chandra-prakash-meher-b1a671126/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
